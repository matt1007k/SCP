...
var render = function() {
  ...
  return _c(
    ...
    [
      _c(
        "v-flex",
        { staticClass: "d-flex", attrs: { xs12: "", sm8: "", md5: "" } },
        [
          _c(
            "v-container",
            [
              _c("h1", { staticClass: "text-xs-center indigo--text" }, [
                _vm._v("Sistema de Constancia de Pago")
              ]),
              _vm._v(" "),
              _c(
                "v-card",
                [
                  _c("v-container", [
                    _c(
                      "div",
                      { staticClass: "mt-4 mb-2 title text-xs-center" },
                      [_vm._v("Iniciar Sesion")]
                    ),
                    _vm._v(" "),
                    _c("p", { staticClass: "body-1" }, [
                      _vm._v(
                        "Ingresa al sistema para realizar cualquier operacion."
                      )
                    ]),
                    _vm._v(" "),
                    _c(
      ...
      _c("v-flex", {
        ...
        attrs: { xs12: "", sm4: "", md7: "", "fill-height": "" }
      })
    ],
    1
  )
