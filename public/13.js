...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    Submit: function Submit() {
      ...
      axios.post("/usuarios/".concat(this.form.id), this.form).then(function (res) {
        _this.$parent.getData();
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    modalEditar: function modalEditar(persona) {
      ...
      this.$root.editarUsuario.form.email = persona.email; // this.$root.editarUsuario.form.estado = persona.estado;
    }
  },
  computed: {
