...
<body>
    <header>        
        <div class="head-page">
            ...
            <div class="title">
                <h4 class="text-center">
                    <span class="boleta">BOLETA DE PAGO ELECTRÓNICA</span>    
        ...
        <table class="position-relative" style="margin-left: 10%">
            <tbody>
                <tr>
    ...
    <table class="w-100">
        <tbody>
            <tr>                 
                <td class="text-right">
                    <img class="position-absolute" style=" right: 0; border: 1px solid #000" src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(74)->generate('periodo:'.$nombre_mes.' '.$pago->anio.'|'.$pago->persona->dni.'|'.date('d/m/Y H:i:s'))) !!} ">
                </td>
                <td>
                    <tr>
