            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-left fs-header-sm border-sm">
                        ...
                        <p class="text-uppercase">
                            {{ $pago->persona->nivel_magisterial }}/{{ $pago->persona->grupo_ocupacion }}/{{
                            $pago->persona->horas }}
                        </p>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="text-left fs-header-sm border-sm">
                        ...
                        <div>
                            <span>
                                {{ $pago->persona->codigo_fiscal }} {{ $pago->persona->afp_boleta }}/{{
                                $pago->persona->codigo_afp }}
                            </span>
                            <div>
        ...
        <div class="column__child__left">
            ...
            <div class="fs-header w-100 p-sm">
                ...
                <span class="mount__item__left" style="">
                    <?php echo $haber[$nombre_mes]['monto_'. $nombre_mes .'1']?>
                </span>
                @endif
                @if(isset($haber[$nombre_mes]['monto_'. $nombre_mes .'2']))
                <span class="mount__item__left">
                    <?php echo $haber[$nombre_mes]['monto_'. $nombre_mes .'2']?>
                </span>
                @endif
                @if(isset($haber[$nombre_mes]['monto_'. $nombre_mes .'3']))
                <span class="mount__item__left">
                    <?php echo $haber[$nombre_mes]['monto_'. $nombre_mes .'3']?>
                </span>
                @endif
                @if(isset($haber[$nombre_mes]['monto_'. $nombre_mes .'4']))
                <span class="mount__item__left">
                    <?php echo $haber[$nombre_mes]['monto_'. $nombre_mes .'4']?>
                </span>
                @endif
                @endforeach
            </div>
        ...
        <div class="column__child__right">
            ...
            <div class="fs-header w-100s p-sm">
                ...
                <span class="mount__item__left__2" style="">
                    <?php echo $descuento[$nombre_mes]['monto_'. $nombre_mes .'1']?>
                </span>
                @endif
                @if(isset($descuento[$nombre_mes]['monto_'. $nombre_mes .'2']))
                <span class="mount__item__left__2">
                    <?php echo $descuento[$nombre_mes]['monto_'. $nombre_mes .'2']?>
                </span>
                @endif
                @if(isset($descuento[$nombre_mes]['monto_'. $nombre_mes .'3']))
                <span class="mount__item__left__2">
                    <?php echo $descuento[$nombre_mes]['monto_'. $nombre_mes .'3']?>
                </span>
                @endif
                @if(isset($descuento[$nombre_mes]['monto_'. $nombre_mes .'4']))
                <span class="mount__item__left__2">
                    <?php echo $descuento[$nombre_mes]['monto_'. $nombre_mes .'4']?>
                </span>
                @endif
                @endforeach
            </div>
