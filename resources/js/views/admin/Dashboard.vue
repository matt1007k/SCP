<template>
    <v-container fluid grid-list-md>
        <v-layout row wrap class="mb-3">
            ...
            <v-flex xs12 v-else>
                <v-alert :value="true" type="info">
                    <span class="headline"
                        >Usted no tiene ningún permiso, comuníquese con el
                        administrador del sistema.</span
                    >
                </v-alert>
            </v-flex>
        </v-layout>
        <v-layout
            ...
            wrap
            class="mb-2"
            v-if="$auth.can('admin.index') || $auth.isAdmin()"
        >
            <v-flex
                xs12
                sm6
                            ...
                            <div class="mr-4">
                                <v-tooltip bottom>
                                    <template v-slot:activator="{ on }">
                                        <v-icon v-on="on"
                                            >$vuetify.icons.filter</v-icon
                                        >
                                    </template>
                                    <span
                                        >Filtar o ver los total de pagos por año
                                        y estado de personas</span
                                    >
                                </v-tooltip>
                            </div>
